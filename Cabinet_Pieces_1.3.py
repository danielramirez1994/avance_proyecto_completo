...
class AplicacionGabinetes:
    def __init__(self, root):
        ...
        # Diccionario de materiales y grosores (en pulgadas)
        self.materiales_grosores = {
            "Plywood 3/4": 0.75,
            "Plywood 5/8": 0.625,
            "Plywood 1/2": 0.5,
            "Plywood 3/8": 0.375,
    ...
    def setup_frame_izquierdo(self):
        ...
        ttk.Label(self.frame_dimensiones, text="Grosor Material (in):")
    ...
    def agregar_gabinete(self):
        try:
            ...
            for pieza in piezas_gabinete:
                ...
                pieza["grosor"] = self.materiales_grosores.get(pieza["material"], 0.75)
    ...
    def calcular_piezas_base_drawer(self, gabinete):
        ...
        Asigna el grosor automáticamente en función del material.
        """
        ...
        piezas = [
            # Laterales
            {"nombre": "Lateral Izquierdo", "ancho": gabinete["Profundidad"] - 1, "alto": gabinete["Alto"], "material": "Plywood 3/4", "grosor": self.materiales_grosores["Plywood 3/4"],
            ...
            {"nombre": "Lateral Derecho", "ancho": gabinete["Profundidad"] - 1, "alto": gabinete["Alto"], "material": "Plywood 3/4", "grosor": self.materiales_grosores["Plywood 3/4"],
            "orificios_shelf": {"cantidad": total, "diametro": dia, "filas": rows, "distancia_frontal": front, "distancia_trasera": rear, "separacion": space, "distancia_inferior": botton, "distancia_superior": top}},

            # Base
            {"nombre": "Base", "ancho": gabinete["Ancho"] - 2 * self.materiales_grosores["Plywood 3/4"], "alto": gabinete["Profundidad"] - 1, "material": "Plywood 3/4", "grosor": self.materiales_grosores["Plywood 3/4"]},

            # Trasera
            {"nombre": "Trasera", "ancho": gabinete["Ancho"], "alto": gabinete["Alto"] - self.materiales_grosores["Plywood 1/2"], "material": "Plywood 1/2", "grosor": self.materiales_grosores["Plywood 1/2"]},

            # Rails (superior, media)
            {"nombre": "Under Drawer Rail Superior", "ancho": gabinete["Ancho"] - 2 * self.materiales_grosores["Plywood 3/4"], "alto": 3, "material": "Plywood 3/4", "grosor": self.materiales_grosores["Plywood 3/4"]},
            {"nombre": "Upper Drawer Rail Superior", "ancho": gabinete["Ancho"] - 2 * self.materiales_grosores["Plywood 3/4"], "alto": 3, "material": "Plywood 3/4", "grosor": self.materiales_grosores["Plywood 3/4"]},
            {"nombre": "Rear Drawer Rail Superior", "ancho": gabinete["Ancho"] - 2 * self.materiales_grosores["Plywood 3/4"], "alto": 3, "material": "Plywood 3/4", "grosor": self.materiales_grosores["Plywood 3/4"]},
            {"nombre": "Under Drawer Rail Media", "ancho": gabinete["Ancho"] - 2 * self.materiales_grosores["Plywood 3/4"], "alto": 3, "material": "Plywood 3/4", "grosor": self.materiales_grosores["Plywood 3/4"]},

            # Toe Kick (zócalo)
            {"nombre": "Toe Kick", "ancho": gabinete["Ancho"], "alto": toe_kick, "material": "Plywood 3/4", "grosor": self.materiales_grosores["Plywood 3/4"]},
        ]
        ...
        for i, altura_gaveta in enumerate(alturas_gavetas):
            piezas.append({
                ...
                "grosor": self.materiales_grosores["Medex 3/4"]
            })
        ...
        for i, altura_gaveta in enumerate(alturas_gavetas):
            ...
            piezas.append({
                ...
                "ancho": gabinete["Ancho"] - drawer_mount - (self.materiales_grosores["Plywood 3/4"] * 2),  # Ajuste para el montaje de la gaveta
                "alto": altura_box_drawer,  # Altura calculada
                "profundidad": profundidad_box_drawer,  # Profundidad predeterminada
                "material": "Plywood 5/8",  # Material para las cajas de gavetas
                "grosor": self.materiales_grosores["Plywood 5/8"]
            })
    ...
    def calcular_piezas_base_normal(self, gabinete):
        ...
        piezas.extend([
            {"nombre": "Lateral Izquierdo", "ancho": profundidad - 1.25, "alto": alto, "material": "Plywood 3/4", "grosor": self.materiales_grosores["Plywood 3/4"]},
            {"nombre": "Lateral Derecho", "ancho": profundidad - 1.25, "alto": alto, "material": "Plywood 3/4", "grosor": self.materiales_grosores["Plywood 3/4"]},
            {"nombre": "Base", "ancho": ancho - 2 * self.materiales_grosores["Plywood 3/4"], "alto": profundidad - 1.25, "material": "Plywood 3/4", "grosor": self.materiales_grosores["Plywood 3/4"]},
            {"nombre": "Techo", "ancho": ancho - 2 * self.materiales_grosores["Plywood 3/4"], "alto": profundidad - 1.25, "material": "Plywood 3/4", "grosor": self.materiales_grosores["Plywood 3/4"]},
            {"nombre": "Trasera", "ancho": ancho, "alto": alto - self.materiales_grosores["Plywood 1/2"], "material": "Plywood 1/2", "grosor": self.materiales_grosores["Plywood 1/2"]},
        ])

        # Toe Kick (zócalo)
        piezas.append({"nombre": "Toe Kick", "ancho": ancho, "alto": 4, "material": "Plywood 3/4", "grosor": self.materiales_grosores["Plywood 3/4"]})

        # Gaveta superior
        altura_gaveta = gabinete.get("altura_gaveta", 5.875)  # Usar el valor guardado o 6 cm por defecto
        piezas.append({
        ...
        piezas.append({
            "nombre": "Box Drawer",
            "ancho": ancho - drawer_mount - (self.materiales_grosores["Plywood 3/4"] * 2),  # Ajuste para el montaje de la gaveta
            "alto": altura_gaveta - 1.75,  # Altura calculada
            "profundidad": 21,  # Profundidad predeterminada
            "material": "Plywood 5/8",
            "grosor": self.materiales_grosores["Plywood 5/8"]
        })
        ...
        if ancho > 18:
            ...
            piezas.extend([
                {"nombre": "Puerta Izquierda", "ancho": ancho_puerta, "alto": altura_puerta, "material": "Medex 3/4", "grosor": self.materiales_grosores["Medex 3/4"]},
                {"nombre": "Puerta Derecha", "ancho": ancho_puerta, "alto": altura_puerta, "material": "Medex 3/4", "grosor": self.materiales_grosores["Medex 3/4"]},
            ])
        else:
            # Si el ancho es 18" o menor, agregar una sola puerta
            piezas.append({"nombre": "Puerta", "ancho": ancho, "alto": altura_puerta, "material": "Medex 3/4", "grosor": self.materiales_grosores["Medex 3/4"]})
    ...
    def calcular_piezas_wall_cabinet(self, gabinete):
        ...
        # Piezas básicas del gabinete
        piezas.extend([
            {"nombre": "Lateral Izquierdo", "ancho": profundidad - 1, "alto": alto, "material": "Plywood 3/4", "grosor": self.materiales_grosores["Plywood 3/4"]},
            {"nombre": "Lateral Derecho", "ancho": profundidad - 1, "alto": alto, "material": "Plywood 3/4", "grosor": self.materiales_grosores["Plywood 3/4"]},
            {"nombre": "Base", "ancho": ancho - 2 * self.materiales_grosores["Plywood 3/4"], "alto": profundidad - 1, "material": "Plywood 3/4", "grosor": self.materiales_grosores["Plywood 3/4"]},
            {"nombre": "Techo", "ancho": ancho - 2 * self.materiales_grosores["Plywood 3/4"], "alto": profundidad - 1, "material": "Plywood 3/4", "grosor": self.materiales_grosores["Plywood 3/4"]},
            {"nombre": "Trasera", "ancho": ancho, "alto": alto - self.materiales_grosores["Plywood 1/2"], "material": "Plywood 1/2", "grosor": self.materiales_grosores["Plywood 1/2"]},
        ])
        ...
        piezas.append({
            "nombre": "Estante",
            "ancho": ancho - 2 * self.materiales_grosores["Plywood 3/4"],  # Ajuste para el grosor del material
            "alto": profundidad - 2,  # Profundidad del estante
            "material": "Plywood 3/4",
            "grosor": self.materiales_grosores["Plywood 3/4"]
        })
        ...
        if ancho > 18:  # Si el ancho es mayor a 18", agregar dos puertas
            ancho_puerta = (ancho / 2) - 0.125  # Ajuste para el espacio entre puertas
            piezas.extend([
                {"nombre": "Puerta Izquierda", "ancho": ancho_puerta, "alto": alto, "material": "Medex 3/4", "grosor": self.materiales_grosores["Medex 3/4"]},
                {"nombre": "Puerta Derecha", "ancho": ancho_puerta, "alto": alto, "material": "Medex 3/4", "grosor": self.materiales_grosores["Medex 3/4"]},
            ])
        else:  # Si el ancho es 18" o menor, agregar una sola puerta
            piezas.append({"nombre": "Puerta", "ancho": ancho, "alto": alto, "material": "Medex 3/4", "grosor": self.materiales_grosores["Medex 3/4"]})
    ...
    def setup_frame_editar_gabinete(self):
        ...
        ttk.Label(self.frame_editar_gabinete, text="Grosor Material (in):")
    ...
    def guardar_cambios_pieza(self):
        ...
        try:
            ...
            # Actualizar el material y el grosor
            nuevo_material = self.combo_material_pieza.get()
            pieza_seleccionada["material"] = nuevo_material
            pieza_seleccionada["grosor"] = self.materiales_grosores.get(nuevo_material, 0.75)  # Grosor predeterminado si no se encuentra el material
